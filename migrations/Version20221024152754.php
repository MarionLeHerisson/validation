 ...
 */
final class Version20221024152754 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE element (id VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE pokemon (id VARCHAR(255) NOT NULL, name VARCHAR(25) NOT NULL, PRIMARY KEY(id))');
